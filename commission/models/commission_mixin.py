...
class CommissionLineMixin(models.AbstractModel):
    ...
    commission_percent = fields.Char(compute="_compute_amount")
    ...
    def _get_commission_amount(self, commission, subtotal, product, quantity):
        ...
        if commission.commission_type == "fixed":
            ...
            commission_percent = product.categ_id.get_categ_commission()
            self.commission_percent = "%s %%" % commission_percent
            return subtotal * (commission_percent / 100.0)
