...
class res_config(models.TransientModel):
    ...
    button_or_scroll = fields.Selection(related='website_id.button_or_scroll', required=True, readonly=False,
                                        help="Define how to show the pagination of products in a shop page "
                                             "with on scroll or button.")
    ...
    price_filter_on = fields.Selection(related='website_id.price_filter_on',
                                       readonly=False)
    allowed_search_brand = fields.Boolean(string='Enable Brand Search', related='website_id.allowed_search_brand',
                                          help='Enable the brand search in website shop', readonly=False)
    ...
    def get_values(self):
        ...
        res.update(allow_reorder=self.env['website'].sudo().get_current_website().allow_reorder)
        return res
