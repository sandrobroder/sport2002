...
class product_label(models.Model):
    ...
    font_html_color = fields.Char(string='Font Color', help="Here you can set a specific HTML color index "
                                                            "(e.g. #ff0000) to display the color of product label text.")
    html_color = fields.Char(string='Color', help="Here you can set a specific HTML color index (e.g. #ff0000) "
                                                  "to display the color of product label.")
    label_style = fields.Selection([('style_1', 'Style 1'), ('style_2', 'Style 2'), ('style_3', 'Style 3'),
