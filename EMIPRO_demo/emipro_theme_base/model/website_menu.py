...
class WebsiteMenu(models.Model):
    ...
    category_menu_styles = fields.Selection([('style1', 'Style 1'), ('style2', 'Style 2'), ('style3', 'Style 3'),
                                             ('style4', 'Style 4'), ('style5', 'Style 5'), ('style6', 'Nested menu')],
                                            'Mega Menu Style')
    ...
    def save(self, website_id, data):
        ...
        for menu in data['data']:
            if 'menu_label_text' in menu and not menu['menu_label_text']:
                menu_id = self.browse(menu['id'])
                menu_id.write({'menu_label_text':menu['menu_label_text']})
                transaltion_records = self.env["ir.translation"].search([('name', '=', 'website.menu,menu_label_text'),
                                                                         ('res_id', '=', menu['id'])])
