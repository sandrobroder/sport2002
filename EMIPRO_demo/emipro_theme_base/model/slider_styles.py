...
class SliderStyles(models.Model):
    ...
    slider_type = fields.Selection([('product', 'Product'), ('category', 'Product Category'), ('brand', 'Product Brand')
                                    ], string="Slider Type", required=True, default='product', readonly=False)
