...
class ProductAttribute(models.Model):
    ...
    exclude_website_ids = fields.Many2many('website', 'website_exclude_rel', string="Hide from Product Filter",
                                           help="Exclude the Attribute from Product Filter listing as well as "
                                                "Quick Filter based on Website selection.")
    ...
    is_swatches = fields.Boolean(string='Use Swatch Image', help="It will show the icon column to set the swatches",
                                 default=True)
    allow_search = fields.Boolean(string='Allow Search',
