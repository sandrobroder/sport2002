...
class ShImportImgZipShop(models.TransientModel):
    ...
    import_extra_images_with_underscore_naming_format = fields.Boolean(string="Import Extra Images With _ Naming Format?")
                                        ...
                                        if just_img_name != "" and model_obj != "" and field_name != "":
                                            ...
                                            if self.is_import_extra_product_media:
                                                if self.import_extra_images_with_underscore_naming_format:
                                                    first = self.spli_function(just_img_name,just_img_name.count('_'))
                                                    try:
                                                        has_integer = int(first[1])
